...
from utils import util, xdv, globo
...
model_config = {
    ...
    'graph_filename' : os.path.join(globo.MODEL_PATH,"fsd-sinet-vgg41-tlpf-1.pb"),
    'metadata_file'  : os.path.join(globo.MODEL_PATH,"fsd-sinet-vgg41-tlpf-1.json"),
